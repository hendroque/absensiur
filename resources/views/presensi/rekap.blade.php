        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-4">
                    <div class="card">
                        <div class="card-body">
                            <form action="/presensi/cetakrekapbulan" target="_blank" method="POST">
                                @csrf
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <select name="bulan_awal" id="bulan" class="form-select">
                                                <option value="">Pilih Bulan</option>
                                                @for ($i = 1; $i <= 12; $i++)
                                                    <option value="{{ $i }}"
                                                        {{ date('m') == $i ? 'selected' : '' }}>{{ $namabulan[$i] }}
                                            ...
                                            <select name="bulan_akhir" id="bulan" class="form-select">
                                                <option value="">Pilih Bulan</option>
                                                @for ($i = 1; $i <= 12; $i++)
                                                    <option value="{{ $i }}"
                                                        {{ date('m') == $i ? 'selected' : '' }}>{{ $namabulan[$i] }}
