                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ Request('nip') }}" class="form-control" name="nip"
                        ...
                        <tbody>
                            @foreach ($izinsakit as $d)
                                <tr>
                                    ...
                                    <td>
                                        @if ($d->status == 'CB')
                                            <span class="">Cuti Bersama</span>
                                        @elseif ($d->status == 'CH2')
                                            <span class="">Cuti Melahirkan</span>
                                        @elseif ($d->status == 'S1')
                                            <span class="">Sakit Dengan Surat Dokter</span>
                                        @elseif ($d->status == 'P1')
                                            <span class="">Ijin Tertulis</span>
                                        @elseif ($d->status == 'P2')
                                            <span class="">Tugas Luar</span>
                                        @elseif ($d->status == 'CK')
                                            <span class="">Cuti Kematian</span>
                                        @elseif ($d->status == 'C')
                                            <span class="">Cuti Tahunan</span>
                                        @elseif ($d->status == 'C1')
                                            <span class="">Cuti Anak Lahir/Khitan/Baptis</span>
                                        @endif
                                    </td>
                                    <td>{{ $d->keterangan }}</td>
                                    <td>
