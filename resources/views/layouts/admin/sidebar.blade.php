<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
  <div class="container-fluid">
    ...
    <h1 class="navbar-brand navbar-brand-autodark">
      <a href=".">
        <img src="{{ asset('tabler/static/logo-white.png') }}" width="110" height="32" alt="Tabler" class="navbar-brand-image">
      </a>
    </h1>
    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu {{ request()->is('pegawai*') || request()->is('bagian*') ? 'show' : '' }}">
            <div class="dropdown-menu-columns">
              <div class="dropdown-menu-column">
                <a class="dropdown-item {{ request()->is(['pegawai', '/pegawai']) ? 'active' : '' }}" href="/pegawai">
                  Data Pegawai
                </a>
                <a class="dropdown-item {{ request()->is(['bagian', '/bagian']) ? 'active' : '' }}" href="/bagian">
                  Data Bagian
                </a>
              </div>
            </div>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu {{ request()->is(['presensi', 'presensi/*']) ? 'show' : '' }}">
            <div class="dropdown-menu-columns">
              <div class="dropdown-menu-column">
                <a class="dropdown-item {{ request()->is(['presensi', 'presensi/laporan']) ? 'active' : '' }}" href="/presensi/laporan">
                  Absensi
                </a>
                <a class="dropdown-item {{ request()->is(['presensi', 'presensi/rekap']) ? 'active' : '' }}" href="/presensi/rekap">
                  Rekap Absensi
                </a>
              </div>
            </div>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu {{ request()->is(['konfigurasi', 'konfigurasi/*']) ? 'show' : '' }}">
            <div class="dropdown-menu-columns">
              <div class="dropdown-menu-column">
                <a class="dropdown-item {{ request()->is(['konfigurasi', 'konfigurasi/jamkerja']) ? 'active' : '' }}" href="/konfigurasi/jamkerja">
                  Jam Kerja
                </a>
                <a class="dropdown-item {{ request()->is(['konfigurasi', 'konfigurasi/jamkerjabag']) ? 'active' : '' }}" href="/konfigurasi/jamkerjabag">
                  Jam Kerja Bagian
                </a>
              </div>
            </div>
