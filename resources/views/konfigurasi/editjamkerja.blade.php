<form action="/konfigurasi/updatejamkerja" method="POST" id="formjk">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $jam_kerja->kode_jam_kerja }}" class="form-control"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $jam_kerja->jam_masuks }}" class="form-control" name="jam_masuks"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $jam_kerja->jam_pulangs }}" class="form-control" name="jam_pulangs"
